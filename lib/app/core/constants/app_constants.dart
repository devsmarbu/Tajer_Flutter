...
//
  ...
  static const String addToWishlist = "/dashboard/account/add-remove-wish-list-product";
  ...
  static const String moveCartItemToWishlist = "/account/add-remove-wish-list-product";
  static const String cartRemove = "/cart/remove";
  static const String paymentSummaryWithShippingSelection = "checkout/payment-summary-with-shipping-selection";
  ...
  static const String returnRequestSearch = "dashboard/buyer/order-return-request-search";
  static const String returnRequestDetail = "dashboard/buyer/view-order-return-request/";
  static const String exchangeRequestDetail = "dashboard/buyer/view-order-exchange-request/";
  static const String withdrawOrderReturnRequest = "dashboard/buyer/withdraw-order-return-request/";
  static const String orderReturnRequestSearch = "dashboard/buyer/order-exchange-request-search";
  static const String withdrawOrderExchangeReturnRequest= "dashboard/buyer/withdraw-order-exchange-request/";
  static const String orderCancellationRequestSearch= "dashboard/buyer/order-cancellation-request-search";
  ...
  static const String setUpRequestWithdrawal= "dashboard/account/setup-request-withdrawal";
  ...
  static const String threadMessageSearch= "dashboard/account/thread-message-search";
  static const String orderReturnRequestMessageSearch= "dashboard/account/order-return-request-message-search";
  static const String orderExchangeRequestMessageSearch= "dashboard/account/order-exchange-request-message-search";
  static const String sendMessage= "dashboard/account/send-message";
  static const String sendMessageReturnOrder= "dashboard/buyer/set-up-return-order-request-message";
  static const String sendMessageExchangeOrder= "dashboard/buyer/set-up-exchange-order-request-message";
  ...
  static const String rewardPointsSearch= "dashboard/buyer/reward-points-search";
  ...
  static const String updateProfileInfo= "dashboard/account/update-profile-info";
  static const String uploadProfileImage= "dashboard/account/upload-profile-image";
  static const String removeProfileImage= "dashboard/account/remove-profile-image";
  ...
  static const String orderExchangeRequest= "dashboard/buyer/setup-order-exchange-request";
  static const String orderReturnRequest= "dashboard/buyer/setup-order-return-request";
  ...
  static const String pushNotificationsList= "dashboard/account/push-notifications";
  static const String readAllNotification= "dashboard/account/read-all-notifications";
  static const String orderFeedback= "dashboard/buyer/order-feedback/";
  static const String setUpWalletRecharge= "dashboard/account/set-up-wallet-recharge";
  static const String walletGiftSelection= "checkout/wallet-gift-selection";
  static const String setUpOrderFeedback= "dashboard/buyer/setup-order-feedback";
}
